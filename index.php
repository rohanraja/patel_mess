...
<!-- 	<link rel="stylesheet" href="css/calc_edit.css" />
 -->
	...
	<div class="span3 bs-docs-sidebar " id="nav_menu">
		...
		<li onclick=""><a href="#teaching"><i class="icon-chevron-right"></i> Breakfast</a></li>
		<li onclick=""><a href="#supervision"><i class="icon-chevron-right"></i> Lunch</a></li>
		<li onclick=""><a href="#research"><i class="icon-chevron-right"></i> Snacks </a></li>
		<li onclick=""><a href="#admin"><i class="icon-chevron-right"></i> Dinner </a></li>
