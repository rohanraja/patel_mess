	...
	sfid = $.cookie('staffid');
	 ...
	 $.ajax({
	 	async: false,
	 		...
	 		contentType: "html",
	 		dataType: "html",
	 		url: 'return_masterlist_ajax_exp.php?a='+ a + '&b='+ b + '&c='+ c + '&d='+ d + '&per=' + p + '&filter=' + filt+ '&sem=' + sem + '&dept=' + dept + '&sid=' + sfid,
	 		success: function(data) {
	 			$('#resultview').html(data);

	 			 drawChart(parseInt($('#tgrtotal').html()),parseInt($('#sgrtotal').html()),parseInt($('#rgrtotal').html()),parseInt($('#agrtotal').html()));
