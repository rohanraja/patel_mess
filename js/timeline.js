...
function oncheckchange_autosem(e)
{
	...
	while(condition)
	{
		...
		set_data(1, 1, 1, 1, 0, semmm, currdept, filt);
	...
	drawChart_custom_auto(finaltotsems, "Total Workload", "chart_div1", "black");
	drawChart_custom_auto(finaltsems, "Teaching Workload", "chart_div2", "blue");
	drawChart_custom_auto(finalssems, "Supervision Workload", "chart_div3", "red");
	drawChart_custom_auto(finalrsems, "Research Workload", "chart_div4", "grey");
	drawChart_custom_auto(finalasems, "Administrative Workload", "chart_div5", "green");
	 ...
	 $.ajax({
	 	async: false,
	 		...
	 		success: function(data) {
				...
				$('#resultview').append('<div class="" id="chart_div6" style="width: 900px; height: 450px"></div><div class="" class="offset2" id="chart_div1" style="width: 600px; height: 300px"></div></div><div class="" id="chart_div2" style="width: 600px; height: 300px"></div></div><div class="" id="chart_div3" style="width: 600px; height: 300px"></div></div><div class="" id="chart_div4" style="width: 600px; height: 300px"></div></div><div class="" id="chart_div5" style="width: 600px; height: 300px"></div></div>');
	 			onloading_complete();
