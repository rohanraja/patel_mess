...
<form action="list_with_date.php" method="post">
	<fieldset style="display:inline">
		<legend>Start Date</legend>
  <label for="sday">Day (1-31)</label>
   <input type="number" min='1' max='31' name="sday" value = "1">
  <label for="smonth">Month (1-12)</label>
   <input type="number" min='1' max='12' name="smonth" value = "<?= $month ?>">
  <label for="syear">Year</label>
   <input type="number" min='2013' max='2020' name="syear" value="<?= $mydate[year]; ?>">
 </fieldset>
 <fieldset style="display:inline; margin-left : 40px;">
		<legend>End Date</legend>
  <label for="eday">Day (1-31)</label>
   <input type="number" min='1' max='31' name="eday" value = "1">
  <label for="emonth">Month (1-12)</label>
   <input type="number" min='1' max='12' name="emonth" value = "<?= $month+1 ?>">
  <label for="eyear">Year</label>
   <input type="number" min='2013' max='2020' name="eyear" value="<?= $mydate[year]; ?>">
 </fieldset>

  <fieldset style="display:inline; margin-left : 40px;">
		<legend>Choices Month</legend>
  <label for="cmonth">Month (1-12)</label>
   <input type="number" min='1' max='12' name="cmonth" value="<?= $month ?>">
  <label for="cyear">Year</label>
   <input type="number" min='2013' max='2020' name="cyear" value="<?= $mydate[year]; ?>">
 </fieldset>
