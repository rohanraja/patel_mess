 ...
 -->
	...
	<div class="span3 bs-docs-sidebar " id="nav_menu" style="display:none">
		...
		<div class="teachForm  span12 " id="resultview">
			...
			<section id="teaching">
				...
				<h2 class="description" for="element_1">Breakfast Options of All Students</h2><p id="li_1">
	...
	<?php 
		...
		while($row = mysql_fetch_array($result_db)) {
			 ...
			 $choices = get_alpha_options($row['choices_b']);
		...
		echo '<tr><td></td><td></td><td>Option : A</td>';
		for($jj=0;$jj<7;$jj++)
			echo '<td>'.$a[$jj].'</td>';
		echo '</tr>';
		echo '<tr><td></td><td></td><td>Option : B</td>';
		for($jj=0;$jj<7;$jj++)
			echo '<td>'.$b[$jj].'</td>';
		echo '</tr>';
		echo '<tr><td></td><td></td><td>Option : C</td>';
		for($jj=0;$jj<7;$jj++)
			echo '<td>'.$c[$jj].'</td>';
		echo '</tr>';
		echo '<tr><td></td><td></td><td>Option : D</td>';
		for($jj=0;$jj<7;$jj++)
			echo '<td>'.$d[$jj].'</td>';
		echo '</tr>';
